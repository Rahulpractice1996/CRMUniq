...
<%@ include file="fragments/nav.jsp" %>
    <div class="showmanagercontainer">
        <h2>Add Sales User belong to Manager ${managerName}</h2>
            ...
            <form action="/buildteam" method="post">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="UnassignedSalesUser" items="${UnassignedSalesUsers}">
                            <tr>
                                <td><input type="checkbox" name="salesUserIds" value="${UnassignedSalesUser.EID}"></td>
                                ...
                                <td>-</td>
                                <td class="action-links"><a href="/AddSalesUers?managerId=${manager.EID}">Assign Leads</a></td>
                            </tr>
                        </c:forEach>
                        <!-- Repeat rows as needed with assigned sales user details -->
                        <c:forEach var="assignedSalesUser" items="${assignedSalesUsers}">
                            <tr>
                                <td><input type="checkbox" name="salesUserIds" value="${assignedSalesUser.EID}"></td>
                                ...
                                <td class="action-links"><a href="/AddSalesUsers?managerId=${manager.EID}">Assigned Leads</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
