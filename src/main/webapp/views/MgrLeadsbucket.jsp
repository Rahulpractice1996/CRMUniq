...
<body>
	...
	<div class="Leadcontainer">
		...
		<form action="/AllocateLeads" method="POST">
			<p>Allocate leads to salesuser</p>
			<div class="form-group-dropdown">

				<input type="hidden" name="managerId" value="-1"> <label
					for="salesUserSelect">Select Sales User:</label> <select
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="/addNewLead" method="post">
						...
						<input type="hidden" value="${Managers.EID}" name="leadOwnerId"> 
						<input type="hidden" value="${Managers.uname}" name="leadOwner"> 
						<input type="hidden" value="${Managers.role}" name="leadOwnerRole">
