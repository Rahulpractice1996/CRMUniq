...
<div class="container-fluid main-container">
    ...
    <div class="left-section">
        ...
        <div class="header-section">
            ...
            <p class="lead-location text-muted">${leads.preferedLocation}, Tamil Nadu, India</p>
            ...
            <div class="status-dropdown">
               <!-- Dropdown menu for selecting a new status -->
                ...
                <input type ="hidden" name="LID" value="${leads.LID}">
                    <select id="statusSelect" class="status-select" name="status">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#emailModal"><i class="icon material-icons">email</i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#phoneModal"><i class="icon material-icons">phone</i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#smsModal"><i class="icon material-icons">sms</i></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="modal-body">
                <form action="/sendEmail" method="post">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="toEmail" value="${leads.email}"readonly name="email" id="recipientEmail" placeholder="Enter recipient's email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="message" rows="5" name="body"  placeholder="Enter message"></textarea>
                    </div>
            ...
            <div class="modal-body">
                <form action="/sms">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="smsSubject" placeholder="Enter subject">
                    </div>
                    <div class="form-group">
                        <label for="smsBody">Message</label>
                        <textarea class="form-control" id="smsBody" rows="5" placeholder="Enter message"></textarea>
                    </div>
